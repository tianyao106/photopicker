...
////                        .centerCrop()
//                        .apply(new RequestOptions().placeholder(R.mipmap.default_error)
//                        .error(R.mipmap.default_error).override(mItemSize,mItemSize))
//                        .into(image);
                RequestOptions options = new RequestOptions() .centerCrop().override(mItemSize,mItemSize) .priority(Priority.HIGH);
