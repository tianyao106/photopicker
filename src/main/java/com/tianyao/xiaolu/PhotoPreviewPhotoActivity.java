...
import com.tianyao.xiaolu.widget.ViewPagerFixed;

import java.util.ArrayList;

public class PhotoPreviewPhotoActivity extends AppCompatActivity implements PhotoPagerAdapter.PhotoViewClickListener {
    ...
    public void updateActionBarTitle() {
        tv_number.setText((mViewPager.getCurrentItem() + 1) + "/" + paths.size());
    }
